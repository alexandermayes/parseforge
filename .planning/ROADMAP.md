...
- [ ] **Phase 1: Foundation — Themes & Consent** - Token audit unlocks a dark/light toggle; consent layer gates ads and PostHog replay
...
|-------|----------------|--------|-----------|
| 1. Foundation — Themes & Consent | 0/TBD | Not started | - |
